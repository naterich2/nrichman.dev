      ...
      <div style={{ position: 'absolute', backgroundAttachment: 'scroll', top: '100%', width: '100%', backgroundColor: '#282c35' }}>
        ...
        <Jumbotron style={{ backgroundAttachment: 'scroll', position: 'relative', left: '15%', width: '70%' }}>
          <Container style={{ width: '40%' }}>
            <Row>
              <h3>About Me</h3>
              <p>Hey I'm Nate!  I'm a Masters student at UW-Madison in Biomedical Engineering.  I did my undergraduate in Biomedical Engineering and minored in Comp. Sci., Biology in Engineering, and research-based honors biology.</p>
